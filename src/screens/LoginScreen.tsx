    ...
    <>
      ...
      /> 
        <KeyboardAwareScrollView
            ...
            extraHeight={100}
          >
          <ScrollView contentContainerStyle={isOpaque ? styles.opaque : styles.transparent, {flexGrow: 1, justifyContent: 'center'}}>
            <View style={Typography.containerTrans}>
              ...
              <View>
                ...
                />
                <ButtonIcon
                  style={[Typography.button, Typography.mb, styles.buttonContainer]}
                  label="Login"
                  onPress={handleLogin}
                />
              </View>
